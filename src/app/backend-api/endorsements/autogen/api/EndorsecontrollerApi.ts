...
export class EndorsecontrollerApi {
     ...
     * @param serviceVersion serviceVersion
     */
    public getEndormentsByServiceMrnUsingGET(serviceMrn: string, serviceVersion: string, extraHttpRequestParams?: any): Observable<models.PageEndorsement> {
        return this.getEndormentsByServiceMrnUsingGETWithHttpInfo(serviceMrn, serviceVersion, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
