...
export class ServicecontrollerApi {
     ...
     * @param version version
     */
    public newServiceCertUsingGET(orgMrn: string, serviceMrn: string, version: string, extraHttpRequestParams?: any): Observable<models.PemCertificate> {
     ...
     * @param version version
     */
    public newServiceCertUsingGET1(orgMrn: string, serviceMrn: string, version: string, extraHttpRequestParams?: any): Observable<models.PemCertificate> {
