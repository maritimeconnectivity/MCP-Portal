...
export class UsercontrollerApi {
    ...
    public getOrganizationUsersUsingGET(orgMrn: string, extraHttpRequestParams?: any): Observable<Array<models.User>> {
        return this.getOrganizationUsersUsingGETWithHttpInfo(orgMrn, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
    ...
    public getOrganizationUsersUsingGET1(orgMrn: string, extraHttpRequestParams?: any): Observable<Array<models.User>> {
        return this.getOrganizationUsersUsingGET1WithHttpInfo(orgMrn, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param orgMrn orgMrn
     */
    public getOrganizationUsersUsingGETWithHttpInfo(orgMrn: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param orgMrn orgMrn
     */
    public getOrganizationUsersUsingGET1WithHttpInfo(orgMrn: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param input input
     */
    public revokeUserCertUsingPOSTWithHttpInfo(orgMrn: string, userMrn: string, certId: number, input: models.CertificateRevocation, extraHttpRequestParams?: any): Observable<Response> {
