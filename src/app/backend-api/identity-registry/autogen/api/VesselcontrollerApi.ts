...
export class VesselcontrollerApi {
    ...
    public getOrganizationVesselsUsingGET(orgMrn: string, extraHttpRequestParams?: any): Observable<Array<models.Vessel>> {
        return this.getOrganizationVesselsUsingGETWithHttpInfo(orgMrn, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
    ...
    public getOrganizationVesselsUsingGET1(orgMrn: string, extraHttpRequestParams?: any): Observable<Array<models.Vessel>> {
        return this.getOrganizationVesselsUsingGET1WithHttpInfo(orgMrn, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param orgMrn orgMrn
     */
    public getOrganizationVesselsUsingGETWithHttpInfo(orgMrn: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param orgMrn orgMrn
     */
    public getOrganizationVesselsUsingGET1WithHttpInfo(orgMrn: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param input input
     */
    public revokeVesselCertUsingPOSTWithHttpInfo(orgMrn: string, vesselMrn: string, certId: number, input: models.CertificateRevocation, extraHttpRequestParams?: any): Observable<Response> {
