...
export class ServiceinstanceresourceApi {
     ...
     * @param sort Sorting criteria in the format: property(,asc|desc). Default sort order is ascending. Multiple sort criteria are supported.
     */
    public searchInstancesByGeometryGeojsonUsingGET (geometry: string, page?: number, size?: number, sort?: Array<string>, extraHttpRequestParams?: any ) : Observable<Array<models.Instance>> {
        ...
        if (geometry !== undefined) {
            queryParameters.set('geometry', String(geometry));
        }
     ...
     * @param sort Sorting criteria in the format: property(,asc|desc). Default sort order is ascending. Multiple sort criteria are supported.
     */
    public searchInstancesByGeometryWKTUsingGET (geometry: string, page?: number, size?: number, sort?: Array<string>, extraHttpRequestParams?: any ) : Observable<Array<models.Instance>> {
     ...
     * @param sort Sorting criteria in the format: property(,asc|desc). Default sort order is ascending. Multiple sort criteria are supported.
     */
    public searchInstancesByLocationUsingGET (latitude: string, longitude: string, page?: number, size?: number, sort?: Array<string>, extraHttpRequestParams?: any ) : Observable<Array<models.Instance>> {
        ...
        if (latitude !== undefined) {
            queryParameters.set('latitude', String(latitude));
        }

        if (longitude !== undefined) {
            queryParameters.set('longitude', String(longitude));
        }
