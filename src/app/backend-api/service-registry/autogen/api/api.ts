...
export const APIS = [DocresourceApi, ElasticsearchindexresourceApi, ServiceinstanceresourceApi, ServicespecificationresourceApi, SpecificationtemplateresourceApi, XmlresourceApi, XsdresourceApi];
